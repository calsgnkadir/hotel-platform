...
| Check | Status | Time |
|---|---|---|
| Frontend (Vercel) | ✅ 200 | 0.26s |
| Backend OpenAPI | ❌ 404 | 0.18s |
| Backend listings (public) | ❌ 404 | 0.18s |
...
| Check | Status | Time |
|---|---|---|
| Login (POST /auth/login) | ❌ 404 | 0.18s |
...
| Check | Status | Time |
|---|---|---|
| GET /listings (no filter) | ⚠️ 404 | 0.17s |
| GET /listings (position) | ⚠️ 404 | 0.17s |
| GET /listings (date filter) | ⚠️ 404 | 0.17s |
...
| Check | Status | Time |
|---|---|---|
| GET /listings (no filter) | ⚠️ 404 | 0.06s |
| GET /listings (position) | ⚠️ 404 | 0.08s |
| GET /listings (date filter) | ⚠️ 404 | 0.08s |
...
| Check | Status | Time |
|---|---|---|
| Login (POST /auth/login) | ❌ 404 | 0.15s |
| Authenticated checks | ⏭️ skipped | login başarısız |
...
| Check | Status | Time |
|---|---|---|
| GET /listings (no filter) | ⚠️ 404 | 0.13s |
| GET /listings (position) | ⚠️ 404 | 0.14s |
| GET /listings (date filter) | ⚠️ 404 | 0.14s |
| GET /v3/api-docs | ⚠️ 404 | 0.14s |
| GET /swagger-ui.html | ⚠️ 404 | 0.12s |
...
| Backend listings (public) | ❌ 404 | 0.23s |
...
| GET /listings (date filter) | ⚠️ 404 | 0.22s |
| GET /v3/api-docs | ⚠️ 404 | 0.21s |
| GET /swagger-ui.html | ⚠️ 404 | 0.24s |
...
| Backend listings (public) | ❌ 404 | 0.14s |
...
| Check | Status | Time |
|---|---|---|
| Login (POST /auth/login) | ❌ 404 | 0.16s |
| Authenticated checks | ⏭️ skipped | login başarısız |
...
| Check | Status | Time |
|---|---|---|
| GET /listings (no filter) | ⚠️ 404 | 0.14s |
| GET /listings (position) | ⚠️ 404 | 0.16s |
| GET /listings (date filter) | ⚠️ 404 | 0.14s |
| GET /v3/api-docs | ⚠️ 404 | 0.14s |
| GET /swagger-ui.html | ⚠️ 404 | 0.12s |
...
| GET /listings (position) | ⚠️ 404 | 0.07s |
| GET /listings (date filter) | ⚠️ 404 | 0.06s |
| GET /v3/api-docs | ⚠️ 404 | 0.08s |
| GET /swagger-ui.html | ⚠️ 404 | 0.10s |
...
| Check | Status | Time |
|---|---|---|
| GET /listings (no filter) | ⚠️ 404 | 0.15s |
| GET /listings (position) | ⚠️ 404 | 0.15s |
| GET /listings (date filter) | ⚠️ 404 | 0.25s |
| GET /v3/api-docs | ⚠️ 404 | 0.16s |
| GET /swagger-ui.html | ⚠️ 404 | 0.16s |
...
| Check | Status | Time |
|---|---|---|
| Login (POST /auth/login) | ❌ 404 | 0.12s |
| Authenticated checks | ⏭️ skipped | login başarısız |
...
|---|---|---|
| GET /listings (no filter) | ⚠️ 404 | 0.08s |
| GET /listings (position) | ⚠️ 404 | 0.10s |
| GET /listings (date filter) | ⚠️ 404 | 0.09s |
| GET /v3/api-docs | ⚠️ 404 | 0.09s |
| GET /swagger-ui.html | ⚠️ 404 | 0.09s |
...
| Check | Status | Time |
|---|---|---|
| Frontend (Vercel) | ✅ 200 | 0.27s |
| Backend OpenAPI | ❌ 404 | 0.13s |
| Backend listings (public) | ❌ 404 | 0.12s |
...
| GET /listings (no filter) | ⚠️ 404 | 0.22s |
| GET /listings (position) | ⚠️ 404 | 0.13s |
| GET /listings (date filter) | ⚠️ 404 | 0.10s |
| GET /v3/api-docs | ⚠️ 404 | 0.10s |
| GET /swagger-ui.html | ⚠️ 404 | 0.12s |
...
| Check | Status | Time |
|---|---|---|
| Login (POST /auth/login) | ❌ 404 | 0.11s |
| Authenticated checks | ⏭️ skipped | login başarısız |
...
| Check | Status | Time |
|---|---|---|
| GET /listings (no filter) | ⚠️ 404 | 0.09s |
| GET /listings (position) | ⚠️ 404 | 0.10s |
| GET /listings (date filter) | ⚠️ 404 | 0.10s |
| GET /v3/api-docs | ⚠️ 404 | 0.10s |
| GET /swagger-ui.html | ⚠️ 404 | 0.09s |
...
| Check | Status | Time |
|---|---|---|
| GET /listings (no filter) | ⚠️ 404 | 0.19s |
| GET /listings (position) | ⚠️ 404 | 0.20s |
| GET /listings (date filter) | ⚠️ 404 | 0.21s |
| GET /v3/api-docs | ⚠️ 404 | 0.20s |
| GET /swagger-ui.html | ⚠️ 404 | 0.23s |
...
| Check | Status | Time |
|---|---|---|
| Frontend (Vercel) | ✅ 200 | 0.18s |
| Backend OpenAPI | ❌ 404 | 0.14s |
| Backend listings (public) | ❌ 404 | 0.11s |
...
| GET /listings (no filter) | ⚠️ 404 | 0.15s |
| GET /listings (position) | ⚠️ 404 | 0.14s |
| GET /listings (date filter) | ⚠️ 404 | 0.16s |
| GET /v3/api-docs | ⚠️ 404 | 0.12s |
| GET /swagger-ui.html | ⚠️ 404 | 0.11s |
...
| Check | Status | Time |
|---|---|---|
| Login (POST /auth/login) | ❌ 404 | 0.13s |
| Authenticated checks | ⏭️ skipped | login başarısız |
...
| Check | Status | Time |
|---|---|---|
| GET /listings (no filter) | ⚠️ 404 | 0.24s |
| GET /listings (position) | ⚠️ 404 | 0.13s |
| GET /listings (date filter) | ⚠️ 404 | 0.13s |
| GET /v3/api-docs | ⚠️ 404 | 0.11s |
| GET /swagger-ui.html | ⚠️ 404 | 0.14s |
...
| GET /listings (date filter) | ⚠️ 404 | 0.08s |
| GET /v3/api-docs | ⚠️ 404 | 0.08s |
| GET /swagger-ui.html | ⚠️ 404 | 0.08s |
...
|---|---|---|
| GET /listings (no filter) | ⚠️ 404 | 0.08s |
| GET /listings (position) | ⚠️ 404 | 0.05s |
| GET /listings (date filter) | ⚠️ 404 | 0.08s |
| GET /v3/api-docs | ⚠️ 404 | 0.06s |
| GET /swagger-ui.html | ⚠️ 404 | 0.05s |
...
|---|---|---|
| GET /listings (no filter) | ⚠️ 404 | 0.15s |
| GET /listings (position) | ⚠️ 404 | 0.12s |
| GET /listings (date filter) | ⚠️ 404 | 0.15s |
| GET /v3/api-docs | ⚠️ 404 | 0.12s |
| GET /swagger-ui.html | ⚠️ 404 | 0.14s |
...
| Check | Status | Time |
|---|---|---|
| Login (POST /auth/login) | ❌ 404 | 0.19s |
| Authenticated checks | ⏭️ skipped | login başarısız |
...
| Check | Status | Time |
|---|---|---|
| GET /listings (no filter) | ⚠️ 404 | 0.16s |
| GET /listings (position) | ⚠️ 404 | 0.18s |
| GET /listings (date filter) | ⚠️ 404 | 0.19s |
| GET /v3/api-docs | ⚠️ 404 | 0.15s |
| GET /swagger-ui.html | ⚠️ 404 | 0.17s |
...
| Frontend (Vercel) | ✅ 200 | 0.16s |
| Backend OpenAPI | ❌ 404 | 0.14s |
| Backend listings (public) | ❌ 404 | 0.15s |
...
| GET /listings (date filter) | ⚠️ 404 | 0.12s |
| GET /v3/api-docs | ⚠️ 404 | 0.13s |
| GET /swagger-ui.html | ⚠️ 404 | 0.15s |
...
| Check | Status | Time |
|---|---|---|
| Frontend (Vercel) | ✅ 200 | 0.78s |
| Backend OpenAPI | ❌ 404 | 0.20s |
| Backend listings (public) | ❌ 404 | 0.16s |
...
| Check | Status | Time |
|---|---|---|
| Login (POST /auth/login) | ❌ 404 | 0.17s |
| Authenticated checks | ⏭️ skipped | login başarısız |
...
| Backend OpenAPI | ❌ 404 | 0.61s |
| Backend listings (public) | ❌ 404 | 0.30s |
...
| Check | Status | Time |
|---|---|---|
| Login (POST /auth/login) | ❌ 404 | 0.33s |
| Authenticated checks | ⏭️ skipped | login başarısız |
...
| Check | Status | Time |
|---|---|---|
| GET /listings (no filter) | ⚠️ 404 | 0.30s |
| GET /listings (position) | ⚠️ 404 | 0.30s |
| GET /listings (date filter) | ⚠️ 404 | 4.32s |
| GET /v3/api-docs | ⚠️ 404 | 1.11s |
| GET /swagger-ui.html | ⚠️ 404 | 0.30s |
...
| GET /listings (no filter) | ⚠️ 404 | 0.16s |
| GET /listings (position) | ⚠️ 404 | 0.14s |
| GET /listings (date filter) | ⚠️ 404 | 0.11s |
| GET /v3/api-docs | ⚠️ 404 | 0.12s |
| GET /swagger-ui.html | ⚠️ 404 | 0.10s |
...
| Frontend (Vercel) | ✅ 200 | 0.34s |
| Backend OpenAPI | ❌ 404 | 0.13s |
| Backend listings (public) | ❌ 404 | 0.07s |
...
| GET /listings (date filter) | ⚠️ 404 | 0.08s |
| GET /v3/api-docs | ⚠️ 404 | 0.07s |
| GET /swagger-ui.html | ⚠️ 404 | 0.07s |
...
| Backend OpenAPI | ❌ 404 | 0.30s |
| Backend listings (public) | ❌ 404 | 0.31s |
...
| Check | Status | Time |
|---|---|---|
| Login (POST /auth/login) | ❌ 404 | 0.29s |
| Authenticated checks | ⏭️ skipped | login başarısız |
...
| Check | Status | Time |
|---|---|---|
| GET /listings (no filter) | ⚠️ 404 | 0.29s |
| GET /listings (position) | ⚠️ 404 | 0.28s |
| GET /listings (date filter) | ⚠️ 404 | 0.31s |
| GET /v3/api-docs | ⚠️ 404 | 0.31s |
| GET /swagger-ui.html | ⚠️ 404 | 0.28s |
...
| Check | Status | Time |
|---|---|---|
| GET /listings (no filter) | ⚠️ 404 | 0.07s |
| GET /listings (position) | ⚠️ 404 | 0.07s |
| GET /listings (date filter) | ⚠️ 404 | 0.13s |
| GET /v3/api-docs | ⚠️ 404 | 0.13s |
| GET /swagger-ui.html | ⚠️ 404 | 0.13s |
...
| GET /listings (date filter) | ⚠️ 404 | 0.13s |
| GET /v3/api-docs | ⚠️ 404 | 0.15s |
| GET /swagger-ui.html | ⚠️ 404 | 0.20s |
