      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-5 space-y-3">
              ...
              return (
                <button key={c.id} onClick={() => setCat(c.id)}
                  ...
                  style={{
                    ...
                    color: active ? 'var(--ah-ink)' : 'var(--ah-ink-3)',
          ...
          <input
            ...
            style={{ background: 'rgba(13, 11, 9, 0.55)', borderColor: 'rgba(31, 41, 55, 0.14)', color: 'var(--ah-ink-2)' }}
          />
        </div>

        <section className="bg-white rounded-2xl shadow-xl border border-brand-200 p-6 sm:p-8">
          <div className="text-[11px] uppercase tracking-widest mb-4" style={{ color: 'var(--ah-ink-3)' }}>
        ...
        <p className="text-center text-[12px] mt-5" style={{ color: 'var(--ah-ink-3)' }}>
    ...
    <div className="py-3">
      ...
      >
        <span className="flex items-center gap-2 min-w-0">
          ...
          <span className="font-semibold text-[14px] truncate" style={{ color: 'var(--ah-ink)' }}>{q}</span>
        </span>
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
             style={{ flexShrink: 0, color: 'var(--ah-card)', transform: open ? 'rotate(180deg)' : 'none', transition: 'transform 200ms' }}>
          <path d="m6 9 6 6 6-6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
      </button>
      {open && (
        <p className="mt-2 text-[13px] leading-relaxed pl-1" style={{ color: 'var(--ah-ink-3)' }}>
          {a}
        </p>
      )}
    </div>
