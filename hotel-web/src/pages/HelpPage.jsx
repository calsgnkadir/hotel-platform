        ...
        <section className="bg-white rounded-2xl shadow-xl border border-brand-200 p-6 sm:p-8">
          ...
          <div className="grid sm:grid-cols-2 gap-3">
            <a href="mailto:destek@ajanshotel.com"
              ...
              <span className="text-[10px] uppercase tracking-widest" style={{ color: '#1e3a5f' }}>E-posta</span>
              <span className="font-mono text-[13px] truncate" style={{ color: '#0c1726' }}>destek@ajanshotel.com</span>
            </a>
            <a href="tel:+902120000000"
               className="flex flex-col gap-1 px-4 py-3 rounded-xl bg-brand-50 border border-brand-100
                          hover:border-brand-400 transition-colors min-w-0">
              <span className="text-[10px] uppercase tracking-widest" style={{ color: '#1e3a5f' }}>Telefon</span>
              <span className="font-mono text-[13px] truncate" style={{ color: '#0c1726' }}>+90 212 000 00 00</span>
            </a>
          </div>
          <p className="text-[12px] mt-4" style={{ color: '#1e3a5f' }}>
...
function FaqItem({ q, a }) {
  ...
  return (
    <div className="py-3">
      ...
      >
        <span className="font-semibold text-[14px]" style={{ color: '#0c1726' }}>{q}</span>
      ...
      {open && <p className="text-[13px] mt-2 leading-relaxed" style={{ color: '#15243d' }}>{a}</p>}
    </div>
  )
}
