  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 text-white relative z-10">
      <div className="w-full max-w-md p-8 text-center"
        ...
        <h1 className="text-2xl font-bold mb-3" style={{ color: '#efefef' }}>
          Email Doğrulama
        </h1>
        ...
        {state === 'loading' && (
          <div className="py-6">
            ...
            <p className="mt-4 text-sm" style={{ color: '#888888' }}>Doğrulanıyor...</p>
          </div>
        )}
        ...
        {state === 'success' && (
          <>
            ...
            <p className="text-sm mb-6" style={{ color: '#efefef' }}>{message}</p>
