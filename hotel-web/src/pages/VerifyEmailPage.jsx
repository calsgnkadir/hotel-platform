  ...
  return (
    <div className="min-h-screen bg-cream-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl border border-brand-200 p-8 text-center">
        <h1 className="text-2xl font-bold mb-3" style={{ color: '#3b0764' }}>
          Email Doğrulama
        </h1>
        ...
        {state === 'loading' && (
          <div className="py-6">
            ...
            <p className="mt-4 text-sm" style={{ color: '#6b21a8' }}>Doğrulanıyor...</p>
          </div>
        )}
        ...
        {state === 'success' && (
          <>
            ...
            <p className="text-sm mb-6" style={{ color: '#3b0764' }}>{message}</p>
