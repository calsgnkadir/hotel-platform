      ...
      {chordActive && !helpOpen && (
        ...
        >
          ...
          >
            ...
            <span className="text-[10px] uppercase tracking-widest font-bold" style={{ color: '#2d968b' }}>
      ...
      >
        <div className="flex items-baseline justify-between mb-5">
          <h2
            ...
            style={{ textShadow: '0 0 14px rgba(15, 118, 110, 0.28)' }}
          >
            Klavye Kısayolları
          </h2>
          <button
              ...
              <span className="flex items-center gap-1">
                {row.keys.map((k, j) => (
                  <span key={j} className="flex items-center gap-1">
                    {j > 0 && <span className="text-[10px]" style={{ color: '#0b5d57' }}>·</span>}
                    <kbd
