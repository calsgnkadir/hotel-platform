  ...
  return (
    <motion.div
      ...
      <input type="text" value={value}
             ...
             style={{ color: 'var(--text-headline)', caretColor: '#d4a853' }} />
      {value && (
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center justify-between gap-2 mt-1.5">
            <div className={`text-[12px] truncate ${hasUnread ? 'font-medium' : 'font-normal'}`}
                 style={{ color: hasUnread ? '#cdb78f' : 'var(--text-secondary)' }}>
          ...
          {[
            ...
            return (
              <button key={opt.id} type="button"
                ...
                style={{
                  background: isActive ? 'rgba(205, 183, 143, 0.14)' : 'rgba(27, 24, 21, 0.75)',
                  color: isActive ? '#cdb78f' : '#928678',
                  border: `1px solid ${isActive ? 'rgba(205, 183, 143, 0.40)' : 'rgba(205, 183, 143, 0.12)'}`,
                }}>
                {opt.label}
                {opt.count > 0 && (
